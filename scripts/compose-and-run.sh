...
#        COMPOSE_PLAYBOOK=<name>.yml to select a playbook under ansible/playbooks/ (default aws-workspace-builder-aws.yml).
...
COMPOSE_PLAYBOOK_VALUE="${COMPOSE_PLAYBOOK-aws-workspace-builder-aws.yml}"
