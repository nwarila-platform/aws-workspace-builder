# `windows_desktop_runtime` role

**Stub.** Reserves the WorkSpace image catalog product `Microsoft-Corporation_Microsoft-Windows-Desktop-Runtime` at fleet pin `10.0.11.50000`.
