# `microsoft_project_2021` role

**Stub.** Reserves the WorkSpace image catalog product `Microsoft-Corporation_Microsoft-Project-Professional-2021` at fleet pin `16.0.14334.20848`.
