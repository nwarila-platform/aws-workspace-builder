# `microsoft_project_2019` role

**Stub.** Reserves the WorkSpace image catalog product `Microsoft-Corporation_Microsoft-Project-Professional-2019` at fleet pin `16.0.10417.20197`.
